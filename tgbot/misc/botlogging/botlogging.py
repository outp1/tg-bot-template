...
class BotLogging:
    ...
    def __init__(
        ...
        config_file: str = f"{dir_path}/loggers.json",
    ...
    def get_bot_logger(self):
        ...
        with open(self.config_file, "r") as f:
            ...
            dict_config["handlers"]["telegram"]["class"] = (
                self.tg_handler_dir.replace("/", ".") + ".TelegramHandler"
            )
            dict_config["loggers"][self.logger_name] = dict_config["loggers"][
                self.template
            ]
